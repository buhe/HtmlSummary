...
struct ProView: View {
    let title: String = "Web Page Summarize"
                ...
                HStack{
                    ...
                    VStack(alignment: .leading){
                        Text("Unlimited Summaries")
                            .bold()
                        Text("Summarize any Web Page without time or word limits.")
                    }
                }
                .padding()
                HStack{
...
Plan auto-renews for $3.99/month until canceled.
""")
                .padding()
                Text(text)
                    .padding()
                ...
                Text("EULA: https://www.apple.com/legal/internet-services/itunes/dev/stdeula/")
                    .padding(.horizontal)
                Text("Privacy: https://github.com/buhe/HtmlSummary/blob/main/PrivacyPolicy.md")
                    .padding(.horizontal)
                HStack{
                    Button{
